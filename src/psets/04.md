...
In the lecture, we introduced the Support Vector Machines (SVM) as a more robust extension of the Rosenblatt Perceptron. In this exercise, you will implement the SVM and apply it to the dataset.
